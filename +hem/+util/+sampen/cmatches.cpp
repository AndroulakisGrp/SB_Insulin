...
/*
Edited by JDS, 2010-06-21

- Renamed from matches.cpp to cmatches.cpp to correspond to its name in Matlab
- Fixed minor compilation errors in GCC 4.4 (variable scoping in for loops)
*/
