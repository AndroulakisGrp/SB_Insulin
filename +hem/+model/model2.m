...
Fins=y(48); gamma=y(49); rho=y(50);       F2=y(51);    G2=y(52); b_V=y(53);
...
dy(48)=dFins;   dy(49)=dgamma;   dy(50)=drho;     dy(51)=dF2;  dy(52)=dG2; dy(53)=db_V;
end